...
public class GoFish {
    ...
    private ArrayList<Card> computerTaken = new ArrayList<>();
    private ArrayList<Card> computerAintgotit = new ArrayList<>();
        ...
        while (card == null) {
            if (!cpu) {
                ...
                if (computer.getHand().size() == 0) {
                    ...
                    card = computer.getCardByNeed(computerAintgotit, computerTaken);
